...
export const typeIdOptionsMap = {
  [LSP1_TYPE_IDS.LSP0ValueReceived]: {
    label: 'LSP0 Value Received',
    value: LSP1_TYPE_IDS.LSP0ValueReceived,
    description: 'Notified when receiving LYX (native tokens)',
  },
  [LSP1_TYPE_IDS.LSP0OwnershipTransferStarted]: {
    ...
    description: 'Notified when ownership transfer starts',
  },
  [LSP1_TYPE_IDS.LSP0OwnershipTransferred_SenderNotification]: {
    ...
    description: 'Notified when ownership is transferred (sender)',
  },
  [LSP1_TYPE_IDS.LSP0OwnershipTransferred_RecipientNotification]: {
    ...
    description: 'Notified when ownership is transferred (recipient)',
  },
  [LSP1_TYPE_IDS.LSP7Tokens_SenderNotification]: {
    ...
    description: 'Notified when LSP7 tokens are sent',
  },
  [LSP1_TYPE_IDS.LSP7Tokens_RecipientNotification]: {
    label: 'LSP7 Tokens Recipient Notification',
    value: LSP1_TYPE_IDS.LSP7Tokens_RecipientNotification,
    description: 'Notified when LSP7 tokens are received',
  },
  [LSP1_TYPE_IDS.LSP7Tokens_OperatorNotification]: {
    ...
    description: 'Notified when LSP7 operator actions occur',
  },
  [LSP1_TYPE_IDS.LSP8Tokens_SenderNotification]: {
    ...
    description: 'Notified when LSP8 tokens are sent',
  },
  [LSP1_TYPE_IDS.LSP8Tokens_RecipientNotification]: {
    label: 'LSP8 Tokens Recipient Notification',
    value: LSP1_TYPE_IDS.LSP8Tokens_RecipientNotification,
    description: 'Notified when LSP8 tokens are received',
  },
  [LSP1_TYPE_IDS.LSP8Tokens_OperatorNotification]: {
    ...
    description: 'Notified when LSP8 operator actions occur',
  },
  [LSP1_TYPE_IDS.LSP9ValueReceived]: {
    label: 'LSP9 Value Received',
    value: LSP1_TYPE_IDS.LSP9ValueReceived,
    description: 'Notified when LSP9 vault receives value',
  },
  [LSP1_TYPE_IDS.LSP9OwnershipTransferStarted]: {
    ...
    description: 'Notified when LSP9 ownership transfer starts',
  },
  [LSP1_TYPE_IDS.LSP9OwnershipTransferred_SenderNotification]: {
    ...
    description: 'Notified when LSP9 ownership is transferred (sender)',
  },
  [LSP1_TYPE_IDS.LSP9OwnershipTransferred_RecipientNotification]: {
    ...
    description: 'Notified when LSP9 ownership is transferred (recipient)',
  },
  [LSP1_TYPE_IDS.LSP14OwnershipTransferStarted]: {
    ...
    description: 'Notified when LSP14 ownership transfer starts',
  },
  [LSP1_TYPE_IDS.LSP14OwnershipTransferred_SenderNotification]: {
    ...
    description: 'Notified when LSP14 ownership is transferred (sender)',
  },
  [LSP1_TYPE_IDS.LSP14OwnershipTransferred_RecipientNotification]: {
    ...
    description: 'Notified when LSP14 ownership is transferred (recipient)',
  },
};
