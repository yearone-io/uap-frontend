...
export const forwarderAssistantTestnet: ExecutiveAssistant = {
  ...
  description:
    'Forward incoming assets to an external address.',
  iconPath: '/assistants/forwarder.jpg',
  links: [{ name: 'X', url: 'https://x.com/yearone_io' }],
  assistantType: 'Executive',
  creatorAddress: '0xfE67D89DeBEC38592aB2FeD217b8bbb28851DF88',
  supportedTransactionTypes: [LSP1_TYPE_IDS.LSP7Tokens_RecipientNotification, LSP1_TYPE_IDS.LSP8Tokens_RecipientNotification],
  configParams: [
    {
      name: 'targetAddress',
      type: 'address',
